...
<template>
  <VDialog max-width="600">
    ...
    <VCard title="전표 수정">
      <VCardText>
        <VRow>
          ...
          <VCol cols="10" sm="4" md="3">
            <AppTextField v-model="slipType" label="전표유형" placeholder="결산" />
          </VCol>
          <VCol cols="10" sm="4" md="6">
            <AppTextField v-model="reportingEmpCode" label="작성자코드" disabled />
          </VCol>
          <VCol cols="10" sm="4" md="6">
            <AppTextField v-model="reportingEmpName" label="작성자명" disabled />
          </VCol>
          <VCol cols="10" sm="4" md="6">
            <AppTextField v-model="deptCode" label="부서코드" @click="isDeptCodeDialogVisible = !isDeptCodeDialogVisible" />
          </VCol>
          <VCol cols="10" sm="4" md="6">
            <AppTextField v-model="deptName" label="부서명" disabled />
          </VCol>
          <VCol cols="10" sm="4" md="6">
            <AppTextField v-model="expenseReport" label="품의내역" type="text" />
          </VCol>
          <VCol cols="10" sm="4" md="6">
            <AppTextField v-model="postingDate" label="사용일자" type="date" />
          </VCol>
          <VCol cols="10" sm="4" md="6">
            <AppTextField v-model="reportingDate" label="작성일자" type="date" />
          </VCol>
        </VRow>
      </VCardText>
    ...
    <AddDeptCodeModal v-model="isDeptCodeDialogVisible" @selected="deptCodeSelected"
