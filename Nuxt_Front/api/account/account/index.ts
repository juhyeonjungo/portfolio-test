...
const ACCOUNTCONTROLLCODE_URL = "/base/accounts/accountControlCode";
const FINANCIALACCOUNTASSOCIATES_URL = "base/financialAccountAssociates";
...
// 분개 상세 코드 조회
function selectCodeDetail(accountCode: any) {
  console.log("이제보내나?");
  return accountApi.get(ACCOUNTCONTROLLCODE_URL, {
    params: { accountCode }
  });
}

// 분개 상세 코드 조회
function selectFinancialAccountAssociatesList() {
  return accountApi.get(`${FINANCIALACCOUNTASSOCIATES_URL}`);
}
