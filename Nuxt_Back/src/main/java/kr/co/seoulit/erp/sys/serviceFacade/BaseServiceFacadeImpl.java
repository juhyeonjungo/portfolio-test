...
import kr.co.seoulit.erp.sys.ApplicationService.LoginApplicationService;
...
public class BaseServiceFacadeImpl implements BaseServiceFacade {
  ...
  public LoginEmpBean findLogin(LoginTo loginData) {


	  LoginEmpBean loginEmpBean =loginApplicationService.getLoginEmpBean(loginData);
