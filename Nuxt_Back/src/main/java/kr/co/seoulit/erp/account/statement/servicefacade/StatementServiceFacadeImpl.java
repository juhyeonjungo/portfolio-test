...
public class StatementServiceFacadeImpl implements StatementServiceFacade {
	...
	//2024-06-07 재무상태표 applicationService에서 여기로 이동.
	//applicationService는 없애는게 좋다고 원장님이 말하심. 구시대 유물이라고 함
	@Autowired
...
//		return statementApplicationService.getIncomeStatement(accountPeriodNo, earlyNo);
//	}

	@Override
	public HashMap<String, Object> getFinancialPosition(String accountPeriodNo, String earlyNo) {
