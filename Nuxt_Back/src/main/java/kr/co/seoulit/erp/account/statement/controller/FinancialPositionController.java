...
//    }
    ...
    public HashMap<String, Object> getFinancialPosition(@RequestParam("accountPeriodNo") @Parameter(description="회계 기수 번호") String accountPeriodNo,
                                                        @RequestParam("earlyNo") @Parameter(description="회계 전기수 번호") String earlyNo) {

        HashMap<String, Object> map = new HashMap<>();
        try {
            HashMap<String, Object> financialPositionList = statementServiceFacade.getFinancialPosition(accountPeriodNo, earlyNo);
